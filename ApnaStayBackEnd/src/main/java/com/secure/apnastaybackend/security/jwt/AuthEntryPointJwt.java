...
@Component
public class AuthEntryPointJwt implements AuthenticationEntryPoint { // for handling unauthorized requests (401) whihc have no token
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException)
        ...
        final ObjectMapper mapper = new ObjectMapper(); // object to json conversion
